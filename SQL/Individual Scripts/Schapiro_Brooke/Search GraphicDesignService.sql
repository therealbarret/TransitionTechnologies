...
sub8.email, sub8.[Services_Description] AS 'Service', GraphicDesignJob AS 'Job Description', sub8.Balance, sub8.Deposit, sub8.Paid, 
PaidToDate, sub8.Service_Date, CASE WHEN sub8.TempClient = 1 THEN 'Yes' ELSE 'No' END AS 'Temp Client' FROM GraphicDesignJob
INNER JOIN (
...
sub7.email,sub7.ServicesID, sub7.[Services_Description], sub7.GraphicDesignJobID, sub7.Balance, sub7.Deposit, sub7.Paid, 
...
ON sub8.GraphicDesignJobID = GraphicDesignJob.GraphicDesignJobID
WHERE sub8.FirstName = 'Vicki' OR sub8.LastName = 'Coons';